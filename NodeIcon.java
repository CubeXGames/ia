...
//Thanks Emmanuel Buorg (https://stackoverflow.com/questions/6590462/java-jtree-with-plus-minus-icons-for-expansion-and-collapse)
public class NodeIcon implements Icon {
    ...
    public void paintIcon(Component c, Graphics g, int x, int y) {
        ...
        if (type == '+') g.drawLine(x + SIZE / 2, y + 2, x + SIZE / 2, y + SIZE - 3);
    }
